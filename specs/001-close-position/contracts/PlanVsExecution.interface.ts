/**
 * Plan vs Execution Analysis Contracts
 * Feature: 001-close-position
 * Date: 2025-11-09
 *
 * Defines comparison metrics displayed when a position closes
 * Supports behavioral training by showing plan vs actual execution quality
 */

import type { Position } from './Position.interface'
import type { FIFOResult } from './FIFO.interface'
