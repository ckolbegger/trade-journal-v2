...
**Purpose**: Project initialization and orientation
...
- [ ] T007
  - Step 1 - Write unit tests for new journal/price types in `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/types/__tests__/journal.test.ts` and `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/types/__tests__/priceHistory.test.ts`
  - Step 2 - Implement type updates in `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/types/journal.ts` and `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/types/priceHistory.ts`
...
- [ ] T008
  - Step 1 - Write unit tests for option validation rules in `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/__tests__/PositionValidator.test.ts`, `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/__tests__/TradeValidator.test.ts`, `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/__tests__/PriceValidator.test.ts`
  - Step 2 - Implement validation updates in `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/validators/PositionValidator.ts`, `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/validators/TradeValidator.ts`, `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/domain/validators/PriceValidator.ts`
...
- [ ] T010 [US1]
  ...
  - Step 2 - Implement UI + data wiring in `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/pages/PositionCreate.tsx` and `/home/ckolbegger/src/trade-journal-v2/worktree/codex/src/lib/position.ts`
...
## Phase 6: User Story 4 - Record Expiration Worthless (Priority: P2)
...
## Phase 8: User Story 6 - Update Prices for Stock and Option (Priority: P2)
...
## Phase 9: User Story 7 - View Positions on Dashboard (Priority: P3)
...
- **User Story 2 (P1)**: Can start after Foundational (Phase 2) - Requires US1 plan fields to create STO trades
- **User Story 3 (P1)**: Can start after Foundational (Phase 2) - Requires US2 to have an open short put
- **User Story 4 (P2)**: Can start after Foundational (Phase 2) - Requires US2 to have an open short put
- **User Story 5 (P2)**: Can start after Foundational (Phase 2) - Requires US2 to have an open short put
- **User Story 6 (P2)**: Can start after Foundational (Phase 2) - Requires US2 trades for pricing
- **User Story 7 (P3)**: Can start after Foundational (Phase 2) - Depends on US1/US2 data for display

### Parallel Opportunities

- Setup tasks (T001–T002) can run in parallel
- Foundational helpers (T004–T005) can run in parallel
...
3. Complete Phase 3: User Story 1 (unit tests → implementation → integration tests)
...
8. Add User Story 7 → Test independently → Demo
